...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        <div>
            <asp:Label ID="title" runat="server" Text="Item Category"></asp:Label>
        </div>
        <br />
        <br />
        <div>
        ...
        <br />
        <div>
            <asp:GridView ID="categoryGridView" runat="server" DataKeyNames="CATEGORY_ID" Height="369px" HorizontalAlign="Justify" PageSize="15" Width="1136px" CellPadding="5" CellSpacing="5" GridLines="Horizontal" OnRowDataBound="categoryGridView_RowDataBound" OnRowEditing="categoryGridView_RowEditing" OnRowCancelingEdit="categoryGridView_RowCancelingEdit" OnRowUpdating="categoryGridView_RowUpdating" OnRowDeleting="categoryGridView_RowDeleting" AutoGenerateEditButton="true" AutoGenerateDeleteButton="true">
                </asp:GridView>
        </div>
