...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
      <div>
        ...
        <br />
            ...
            <br />
            <asp:TextBox ID="txtStockDate" Type="Date" Height="25px" runat="server" Width="300px"></asp:TextBox>
        </div>
        <br />
                <div>
        ...
        <br />
         <div>
             <asp:GridView ID="itemGridView" DataKeyNames="ITEM_ID" Height="369px" HorizontalAlign="Justify" Width="1236px" CellPadding="5" CellSpacing="10" GridLines="Horizontal" runat="server" OnRowDataBound="itemGridView_RowDataBound" OnRowEditing="itemGridView_RowEditing" OnRowUpdating="itemGridView_RowUpdating" OnRowCancelingEdit="itemGridView_RowCancelingEdit" OnRowDeleting="itemGridView_RowDeleting" AutoGenerateEditButton="true" AutoGenerateDeleteButton="true" PageSize="15" >
